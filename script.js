...
const translations = {
  en: {
    ...
    hero_badge: "Built by artists, for artists",
    hero_headline: "Free 3D models & Blender assets — powered by creators.",
    hero_sub: "A growing library of rigged characters, environments, shaders and animation kits. Every file is community-sourced, checked, and free to download — no accounts, no watermarks.",
    ...
    chip_assets: "Assets",
    stat_assets_label: "Assets available",
    stat_downloads: "Downloads served",
    ...
    footer_built: "Built by the community.",
    footer_admin: "Admin",
  ...
  ar: {
    ...
    hero_badge: "صنعها فنانون، لخدمة الفنانين",
    hero_headline: "موديلات ثلاثية الأبعاد وأصول بلندر مجانية — من صنع المبدعين.",
    hero_sub: "مكتبة متنامية من الشخصيات المجهزة بالريغ، البيئات، الشيدرات، وحزم الأنيميشن. كل ملف تم فحصه ومتاح للتحميل مجانًا — بدون حساب، وبدون علامات مائية.",
    ...
    chip_assets: "أصول",
    stat_assets_label: "أصل متاح",
    stat_downloads: "عملية تحميل",
    stat_free: "مجاني بالكامل",
  ...
  ru: {
    ...
    hero_badge: "Создано художниками для художников",
    hero_headline: "Бесплатные 3D-модели и ассеты Blender — от авторов сообщества.",
    hero_sub: "Растущая библиотека риггованных персонажей, окружений, шейдеров и наборов анимации. Каждый файл проверен и доступен бесплатно — без регистрации и водяных знаков.",
    ...
    chip_assets: "Ассеты",
    stat_assets_label: "ассетов доступно",
    stat_downloads: "загрузок",
    stat_free: "бесплатно всегда",
    ...
    footer_built: "Создано сообществом.",
